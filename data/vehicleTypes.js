...
const WORK_DOCS = [
  { key: 'workPlan', label: '작업계획서', short: '작업계획서', required: true, formUrl: '/forms/work-plan.pdf' },
  { key: 'safetyChecklist', label: '작업안전 체크리스트', short: '체크리스트', required: true },
  { key: 'tbm', label: '작업 전 안전점검(TBM) 회의록', short: 'TBM 회의록', required: true },
  // 현장사진은 자재센터 출입 후 등록하므로 신청 시에는 선택(없어도 신청 가능)
  { key: 'sitePhoto', label: '차량·운전자 현장사진', short: '현장사진', required: false, note: '자재센터 출입 후 등록' },
];
